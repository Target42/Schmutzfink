  ...
  return (
    <article className="help-page">
        ...
        <dl className="help-dl">
          ...
          <div>
            ...
            <dd>
              ...
              Notiz, Tags, eigene Felder und die Bildähnlichkeit gehören zur Sichtung. Filter und
              Suche treffen Sichtungen; Bestand und Karte zeigen jedes Foto nur einmal.
            </dd>
          </div>
          <div>
            <dt>Motiv</dt>
      ...
      <section id="bestand" className="help-section">
        <h2>Bestand</h2>
        <p>
          Unter <Link to="/">Bestand</Link> stehen die Fotos als Kacheln: Vorschau, Notiz,
          Aufnahme- oder Uploadzeit, Koordinaten, Tags, wer hochgeladen hat, zugeordnetes Motiv
          und eigene Felder. Mehrere Sichtungen auf demselben Foto erscheinen nur einmal. Bei einer
          Bildsuche erscheint zusätzlich die Ähnlichkeit in Prozent.
        </p>
        <ul>
          <li>Ein Klick öffnet das Foto mit allen Sichtungen.</li>
          <li>
            Oben rechts lässt sich die Kachelgröße wählen (Groß bis Mini); die Einstellung bleibt im
            Browser gespeichert. Kleinere Kacheln laden mehr Treffer pro Seite.
          </li>
          <li>Viele Treffer werden seitenweise angezeigt.</li>
          {writer ? (
            <li>
      ...
      <section id="suche" className="help-section">
        ...
        <p>
          Dieselben Filter gelten in Liste, Karte und Auswertungen und bleiben in diesem Browser-Tab
          erhalten (auch nach Neuladen), bis der Tab geschlossen wird. Eine Bildsuche als Datei wird
          dabei nicht mitgespeichert. Die Filter lassen sich kombinieren. Das Suchfeld bleibt immer
          sichtbar; weitere Filter öffnen Sie über „Filter“. Auf schmalen Bildschirmen (Tablet/Handy)
          sind sie standardmäßig zugeklappt — ein Badge zeigt, wie viele Zusatzfilter aktiv sind. Die
          Navigation steckt dort hinter „Menü“. Enter in der Suche schließt die Tastatur. Mit
          „Fertig“ (oben und unten) kehren Sie zur Karte bzw. Liste zurück; die Filterfelder
          lassen sich scrollen. Die
          Trennlinie zwischen Filtern und Treffern bzw. Karte lässt sich ziehen; ein Doppelklick setzt
          die Größe zurück.
        </p>
        <dl className="help-dl">
          <div>
          ...
          <div>
            <dt>Bearbeitung</dt>
            <dd>
              Offen: Fotos mit genau einer Ganzbild-Sichtung ohne Motiv — typisch nach dem Upload,
              noch ohne Rechteck. Bearbeitet: mindestens ein Ausschnitt, ein Motiv oder mehrere
              Sichtungen.
            </dd>
          </div>
          <div>
      ...
      <section id="karte" className="help-section">
        ...
        <ul>
          ...
          <li>Fotos ohne Koordinaten erscheinen hier nicht — sie stehen nur in der Liste.</li>
          <li>
        ...
        {writer ? (
          <>
            <p>
              ...
              lassen sich mit den Trennlinien in der Größe anpassen. Für Aufnahmen vor Ort gibt es
              die <Link to="/app">Android-App</Link>: Kamera und GPS kommen direkt vom Gerät,
              ohne EXIF aus der Galerie.
            </p>
            <h3>Bilder</h3>
            <ol>
              <li>
                Dateien wählen oder in die Ablagefläche ziehen. Steckt GPS im EXIF, wird der Ort
                übernommen und die Adresse per OpenStreetMap ermittelt. Bei mehreren Dateien
                erscheint eine Warteschlange.
              </li>
              <li>
              ...
              <li>
                ...
                rechnet dann nur mit diesem Bereich; das gespeicherte Bild bleibt vollständig.
                Sehr große Aufnahmen werden beim Upload auf max. 2048&nbsp;px Kantenlänge
                verkleinert — für Umrahmen und Suche reicht das.
              </li>
              <li>
      ...
      <section id="mobile" className="help-section">
        <h2>Android-App</h2>
        {writer ? (
          <p>
            Unter <Link to="/app">Android-App</Link> (auch im Kontomenü) laden Sachbearbeiter und
            Admins die signierte APK herunter. Installation aus dieser Quelle bzw. über das
            Geräte-Management der Behörde. In der App die Server-URL dieses Portals eintragen.
            Updates erscheinen dort als neue Version.
          </p>
        ) : (
          <p className="help-note">
            Die Android-App ist für Aufnahmen vor Ort gedacht und steht Sachbearbeitern sowie
            Admins zur Verfügung.
          </p>
        )}
      </section>
      ...
      <section id="datensatz" className="help-section">
        ...
        <p>
          Die Detailseite zeigt das Foto, alle Rechtecke und die Metadaten der gewählten
          Sichtung. „Original öffnen“ lädt die gespeicherte Datei (ggf. verkleinert). {writer ? '„Bearbeiten“ schaltet in den Änderungsmodus.' : ''}
          ...
          <>
            ...
            <ul>
              ...
              <li>
                ...
                Aufnahmezeit gelten für das ganze Foto. „Speichern“ steht oben rechts neben
                „Zur Ansicht“.
              </li>
            </ul>
          </>
      ...
      <section id="motive" className="help-section">
        ...
        {writer ? (
          <ul>
            <li>
              An einer Sichtung „Vorhandenes Motiv zuordnen“ wählen — unabhängig von CLIP, z.&nbsp;B.
              gleicher Stil bei anderem Textinhalt.
            </li>
            <li>
              Oder „Motiv beginnen“ — Titel kommt zunächst aus der Notiz und lässt sich später
              ändern.
            </li>
      ...
      <section id="grenzen" className="help-section">
        ...
        <ul>
          ...
          <li>
            Nach der Frist werden GPS und Adresse im Katalog entfernt. In älteren Originaldateien
            kann EXIF-GPS noch stecken — gespeicherte Dateien werden dafür nicht umgeschrieben.
            Neu verkleinerte Uploads speichern kein EXIF mehr in der Bilddatei.
          </li>
          <li>
