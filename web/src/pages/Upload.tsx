...
import { caseKindLabel, type Case, type GeoAddress, type ImportResult, type Roi } from '../types.ts'
...
export function UploadPage() {
  ...
  async function onSubmit(e: FormEvent<HTMLFormElement>) {
    ...
    if (address) data.set('address', JSON.stringify(address))
        ...
        <Split id="sf.split.upload.cols" axis="x" defaultPct={56} minA={240} minB={260}>
          ...
          <div className="panel stack form-scroll">
            <fieldset className="gps-block">
              ...
              <LocationPicker lat={latN} lon={lonN} onChange={setFromMap} onAddress={setAddress} />
              <div className="split">
                <label>
                  Breite
                  <input
...
function gpsHint(source: GpsSource, hasGps: boolean) {
  if (source === 'exif') return 'Koordinaten aus dem Bild gelesen. Adresse wird ermittelt; du kannst den Ort auf der Karte anpassen.'
